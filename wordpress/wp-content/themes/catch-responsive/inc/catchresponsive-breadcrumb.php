...
if( !function_exists( 'catchresponsive_custom_breadcrumbs' ) ) :
	...
	function catchresponsive_custom_breadcrumbs( $showOnHome, $delimiter ) {
		...
		$text['category'] = __( '%1$s Archive for %2$s', 'catchresponsive' ); // text for a category page
		$text['search']   = __( '%1$sSearch results for: %2$s', 'catchresponsive' ); // text for a search results page
		$text['tag']      = __( '%1$sPosts tagged %2$s', 'catchresponsive' ); // text for a tag page
		$text['author']   = __( '%1$sView all posts by %2$s', 'catchresponsive' ); // text for an author page
