...
if ( ! function_exists( 'catchresponsive_post_navigation' ) ) :
	...
	function catchresponsive_post_navigation() {
		...
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next &rarr;', 'catchresponsive' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Next post:', 'catchresponsive' ) . '</span> ' .
				'<span class="post-title">%title</span>',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( '&larr; Previous', 'catchresponsive' ) . '</span> ' .
				'<span class="screen-reader-text">' . __( 'Previous post:', 'catchresponsive' ) . '</span> ' .
				'<span class="post-title">%title</span>',
		) );
